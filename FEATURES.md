...
- [x] Bech32-encoded strings return lowercase in `destination.value`
- [x] Legacy base58 on-chain addresses preserve input casing
- [x] Transaction ids return lowercase hex
